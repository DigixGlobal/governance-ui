...
// custom
import openMarketplaceAndAcceptTerms from '../support/action/openMarketplaceAndAcceptTerms';
import openProvenanceAndAcceptTerms from '../support/action/openProvenanceAndAcceptTerms';
import registerMarketplaceAccount from '../support/action/registerMarketplaceAccount';

defineSupportCode(({ Given }) => {
  // custom
  Given(/^I open Marketplace and agree to the terms/, openMarketplaceAndAcceptTerms);
  Given(/^I open Provenance and agree to the terms/, openProvenanceAndAcceptTerms);
  Given(/^I register (new|existing|invalid) account in Marketplace/, registerMarketplaceAccount);
