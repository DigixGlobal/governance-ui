...
import AddressInput from '~/libs/material-ui/components/common/address_input';
import ValueInput from '~/libs/material-ui/components/common/value_input';
...
export default class BaseTokenTransferForm extends Component {
  ...
  render() {
    ...
    const sendAll =
      ...
      web3.eth
        .balance(from)
        .minus(toBigNumber(gas).mul(gasPrice))
        .shift(-18);
    // calculate gas
    return (
      <Form.Field>
        ...
        <ValueInput color={network.color} label="Value" name="ethValue" {...{ symbol, sendAll, formChange, formData }} />
      </Form.Field>
    );
  }
}
