...
import NetworkTokensSelector from '~/libs/material-ui/components/common/network_tokens_selector';
  ...
  render() {
    ...
    return (
      <Table.Row negative={removing}>
        ...
        <Table.Cell width={oldItem ? '1' : undefined} colSpan={oldItem ? undefined : '2'}>
          {oldItem ? (
            data.address
          ) : (
            <AddressInput
        ...
        <Table.Cell width="1" style={{ minWidth: '9em' }}>
          {data.address ? (
            ...
            <Label>
              0<Label.Detail>Networks</Label.Detail>
            </Label>
          )}
        </Table.Cell>
      </Table.Row>
