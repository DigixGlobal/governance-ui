...
import DownloadJSONButton from '~/libs/material-ui/components/common/download_json_button';
...
export default class V3KeystoreDownloadButton extends Component {
  ...
  render() {
    return <DownloadJSONButton {...this.props} getFileInfo={this.handleGetFileInfo} />;
  }
}
