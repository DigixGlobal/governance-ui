...
import TrezorKeystoreCreationForm from './trezor_keystore_creation_form';

export default class TrezorKeystoreEditForm extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <TrezorKeystoreCreationForm {...{ formChange, formData }} />
    );
  }
}
